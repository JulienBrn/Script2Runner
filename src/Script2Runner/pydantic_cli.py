...
class CLI(ConfigFile,ExportSchema, BaseSettings, cli_parse_args=True, cli_implicit_flags=True):
    ...
    def __init__(self,**kwargs):
        if "--help" in sys.argv:
            ...
            if export.export_schema:
                ...
                schema["properties"] = {k:v for k,v in schema["properties"].items() if not k in ExportSchema.model_fields and not k in ConfigFile.model_fields}
